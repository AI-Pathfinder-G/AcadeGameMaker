...
미술 P1은 18 PPU, 640×360 fixed world/UI frame, predictive camera, pixel UI·SDF text, exact 32색 palette와 logical pixel outline까지 부분 확정됐다. URP 2D lighting과 reticle exact values는 아직 열려 있다.

...
미술 P1은 18 PPU, 640×360 fixed world/UI frame, predictive camera, pixel UI·SDF text와 world 21색·semantic 11색의 exact sRGB HEX palette까지 부분 확정됐다. outline·URP 2D lighting과 reticle exact values는 아직 열려 있다.

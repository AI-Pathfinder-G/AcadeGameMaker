...
미술 P1은 18 PPU 공통 환경 격자, 640×360 gameplay canvas, 최소 640×360 창과 고정 16:9 letterbox/pillarbox, 2560×1440의 4× 정수 확대, movement/fall predictive fixed-zoom camera 방향이 부분 확정됐다. camera exact values, UI scale, palette·outline·URP 2D lighting은 아직 열려 있다.

...
|---|---|---|---|---|
| OD-ART-001 | P1 | Sol | 확정된 18 PPU·640×360 fixed frame·fixed-zoom predictive camera 안의 dead-zone/look-ahead 수치, UI scale, 팔레트·윤곽선·URP 2D 조명 규칙 | VD-07, VD-08, VD-09 |

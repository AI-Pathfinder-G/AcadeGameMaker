...
P1 가운데 `OD-MOV-001`, `OD-PLAT-001`, `OD-ART-001`은 해결됐다. 이후 사용자 승인으로 AimArc가 수직 데모 후보에 추가되어 스펙 Approved 전환 전 남은 결정은 다음 두 항목이다.

- `OD-AIMARC-001` — 캐릭터 중심 조준 반원·화살표·차지 fill exact geometry

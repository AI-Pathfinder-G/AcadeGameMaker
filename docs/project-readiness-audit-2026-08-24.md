...
- 판정: **P0와 이동 P1 반영 완료 / P1 세 항목과 스펙 승인 전까지 Unity 프로젝트 생성·임포트·구현 보류**
...
P1 가운데 `OD-MOV-001`은 해결됐고 다음 세 항목은 스펙 Approved 전환 전에 정리한다.

- `OD-PLAT-001` — Input System/action map/실제 바인딩과 버전 저장 스키마·손상 복구
...
5. 남은 P1 세 항목 결정, Luna 독립 검토, Sol의 Approved 전환 — 다음 게이트.
